...
namespace Blood_Donation_Project.Controllers
{
    public class NursesController : Controller
    {
        ...
        public NursesController(BloodDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var nurse = await _context.Nurse
                .FirstOrDefaultAsync(m => m.Nurse_ID == id);
            if (nurse == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Nurse_ID,FirstName,LastName,Phone,Email")] Nurse nurse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nurse_ID,FirstName,LastName,Phone,Email")] Nurse nurse)
        {
        ...
        {
            return _context.Nurse.Any(e => e.Nurse_ID == id);
        }
    }
}
